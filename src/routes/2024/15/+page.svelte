<script lang="ts">
    ...
    import type { Point } from './utils.svelte';

    import { beforeNavigate } from '$app/navigation';
    import { Button, Header, ShikiCode, SMWarning, Textarea } from '$lib/components';
    import { BENCHMARK, DEFAULT_MAP, DEFAULT_MOVEMENTS } from '$lib/inputs/2024/input-15';
    import { hexToRgb } from '$lib/utils';

    import { algorithmState, CELL_COLORS, CELL_SIZE, runASolver } from './utils.svelte';
    ...
    const generateInput = () => {
        ...
        const animateCells = (args: AnimateCellsArgs) => {
            ...
            renderingState.forEach((state) => {
                ...
                // Only start rendering after delay is completed
                if (state.progress >= 0) {
...
<section>
    ...
    <p>
        ...
        <br />
        The animation is set to run for 10 seconds, so the iterations per second will be calculated taking into account the number of movements.
    </p>
</section>
